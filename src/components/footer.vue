<template>
  <div class="footer">
    ...
    <!-- <hr> -->
    <div class="row bot_ico">
      <!-- <div class="col-xs-12 col-md-12">Powered By Lianlian.com © 2021</div> -->
      <!-- <img class="col-md-4 col-xs-12  col-md-offset-3"
           src="../assets/image/payment5.png"
           alt=""> -->
    </div>
    <!-- <div class="foot_bottom">
            <div class="footer_cont">
                Powered By Aerpowm.com © 2021
            </div>
        </div> -->
  </div>
</template>
...
export default {
  ...
  methods: {
    toInformation (v) {
      ...
      //   this.$router.replace('/information?type=' + v)
      //   location.reload()
      // } else {
